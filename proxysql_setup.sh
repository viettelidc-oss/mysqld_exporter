...
sudo mysql -uadmin -padmin -P 6032 -h 127.0.0.1 -e "INSERT INTO mysql_query_rules (rule_id,active,match_digest,error_msg,apply) VALUES (1100,1,'^[(drop)|(delete)|(update)|(alter)].* mysql.*','Use of system database is forbidden !',1);"
