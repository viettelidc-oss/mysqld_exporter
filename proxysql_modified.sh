...
PASS=`cat /home/trove/.my.cnf | awk '/password/{print $3}'`
...
MYSQL_USER=`mysql -B -s -P 9999 -uos_admin -p$PASS -h 127.0.0.1 -e "$MYSQL"`
...
mysql -B -s -uos_admin -p$PASS -h 127.0.0.1 -P 9999 -e "$QUERY" | while read line ; do mysql -uadmin -padmin -h 127.0.0.1 -P 6032 -e "$line"; done
